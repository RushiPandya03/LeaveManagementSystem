<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="InstituteAddEdit.aspx.cs" Inherits="Content_Institute_InstituteAddEdit" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphPageContent" Runat="Server">
    <div class="container-fluid">
        ...
        <div class="form-group row ml-1" >
           <label class="col-md-2 col-form-label"><b>Institute Name</b><span class="text-danger">*</span></label>
            <div class="col-md-4">
                ...
                <asp:RequiredFieldValidator ID="rfvInstituteName" runat="server" 
                    ErrorMessage="Enter Institute Name" ValidationGroup="Save" 
                    ControlToValidate="txtInstituteName" CssClass="text-danger"
