<%@ Page Title="" Language="C#" MasterPageFile="~/Display.master" AutoEventWireup="true" CodeFile="Employee_Home.aspx.cs" Inherits="Content_Home_Home_Before_Login" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphDisplayName" runat="Server">
    ...
    <div class="info" style="color:white">
            Hii, <asp:Label ID="lblDisplayname" runat="server"></asp:Label>
    </div>
</asp:Content>
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush text-center">
                        <li class="list-group-item">
                            ...
                            <asp:Button ID="btnDeleteProfile" CssClass="btn bg-gradient-danger" runat="server" Text="Delete Profile" OnClick="btnDeleteProfile_Click" /><br />
                            <br />
                            <asp:Button ID="btnAddLeave" CssClass="btn bg-gradient-info" runat="server" Text="Add Leave" OnClick="btnAddLeave_Click" /><br />
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6 table-responsive card pt-4">
